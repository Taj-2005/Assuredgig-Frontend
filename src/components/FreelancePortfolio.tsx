        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div className={cn(
              ...
              mounted && theme === 'dark' ? 'bg-black border border-white' : 'bg-white border border-black'
            )}>
          ...
          <div className="flex items-center gap-3">
            <button className={cn(
              'px-6 py-2 rounded-lg font-medium transition-all duration-200 border',
              mounted && theme === 'dark'
            ...
            <button className={cn(
              'px-4 py-2 rounded-lg transition-all duration-200 border',
              mounted && theme === 'dark'
                ? 'border-white text-white hover:bg-white hover:text-black'
                : 'border-black text-black hover:bg-black hover:text-white'
            )}>

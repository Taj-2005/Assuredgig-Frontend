  ...
  return (
    <nav
      className={cn(
        ...
        theme === 'light'
          ? isScrolled
            ? 'bg-white/80 border-b border-cyan-100 backdrop-blur-lg shadow-sm'
            : 'bg-white'
          : isScrolled
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <Link href="/" className="text-2xl font-bold transition-all duration-200 hover:opacity-80">
        ...
        {isMobileMenuOpen && (
          <motion.div
            ...
            className={cn(
              "md:hidden",
              theme === 'light' 
                ? 'bg-white border-t border-cyan-100' 
